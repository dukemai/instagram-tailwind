...
const Card: FunctionComponent<CardProps> = () => {
  return (<div className='max-w-md w-full border rounded-md mt-4 dark:bg-black'>
    ...
    <div className="px-4 mt-2">
      colours.cafe 8 <span className="text-slate-300">winter colour palettes ...</span>  <button className="text-slate-400">more</button>
    </div>
    <div className="px-4 mt-2 text-slate-400">
    ...
    <div className="px-4 text-sm mt-2 text-slate-300">
      1 day ago
    </div>
    <div className="border-t border-slate-100 flex items-center mt-4">
      ...
      <textarea autoComplete="off" autoCorrect="off" className="w-full h-10 bg-transparent flex-1 py-2 resize-none" placeholder="Add a comment..."></textarea>


      <button className="px-2">Post</button>
    </div>
  </div>);
}
